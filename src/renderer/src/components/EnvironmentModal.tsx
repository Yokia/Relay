        ...
        <div className="flex-1 flex min-h-0">
          <div className="w-48 border-r border-slate-800 p-3 flex flex-col gap-1 bg-slate-950/40">
            <div className="flex items-center justify-between pb-2 mb-2 border-b border-slate-800/80">
              <span className="text-[11px] font-semibold tracking-wider text-slate-400 uppercase">Environments</span>
            ...
            <div className="flex-1 overflow-y-auto flex flex-col gap-1">
              {envs.map((env) => (
                ...
                >
                  <span className="truncate">{env.name || 'Untitled'}</span>
                  {envs.length > 1 && (
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
          ...
          {currentEnv ? (
            <div className="flex-1 flex flex-col p-4 overflow-hidden">
              <div className="mb-4">
                <label className="text-xs text-slate-400 font-medium block mb-1">Environment Name</label>
                <input
                  type="text"
